...
An extention of the Verde fish model [here](https://github.com/jdtonkin/fishmodel-verde)

Code and data associated with [Rogosch et al. 2019](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecs2.2681) manuscript examining fish communities in the Verde River, AZ, USA. The model is a community-wide stochastic matrix population model that links population dynamics with river flow regimes.

## Readme start

```{r}
## Required manusript libraries
library(ggplot2)
library(plyr)
library(tidyverse)
library(popbio)
## Required simulation libraries
# library(plyr)
# library(tidyverse)
# library(popbio)
library(iterators)
...
#mac package only
# install.packages("doMC", lib="C://Program Files/R/R-3.6.1/library/", repos = "http://cran.case.edu")
...
saveRDS(dr.ne.scenarios.list, './outputs/flows_used.rds')
...
#     saveRDS(means.list, paste0('./outputs/', sppmod, '.rds'))
# 
...
```{r}
#saving outputs
# saveRDS(sppmod.means.list, './outputs/sppmod_flowmod_results.rds')
# saveRDS(sppmod.flowmeans.list, './outputs/sppmod_flowmod_flowmeans_results.rds')

#only need to run model once to begin with...
readRDS('./outputs/sppmod_flowmod_results.rds')
readRDS('./outputs/sppmod_flowmod_flowmeans_results.rds')
```
...
#### `fish-model-all-spp.R` in detail

"is the core model used to generate results in the manuscript: community-wide stage-structured stochastic matrix population model (7 spp.). "

```{r eval=FALSE, include=TRUE}
# source("./R/fish-model-all-spp.R")
## * SETUP ---------------------------------------------------------------------
